...
function Comparison(options, callback) {
    ...
    var API_URL = CR_API_URL

    var comparison = {
        tableSearchAPI: API_URL + '/1.0/table/search',
        geoSearchAPI: FREE_TEXT_SEARCH_API_URL + '/2.1/full-text/search',
        rootGeoAPI: API_URL + `/1.0/geo/tiger${ACS_YEAR_NUMERIC}/`,
        childGeoAPI: API_URL + `/1.0/geo/show/tiger${ACS_YEAR_NUMERIC}`,
    ...
    comparison.makeMapDisplay = function() {
        var API_URL = typeof(CR_API_URL) != 'undefined' ? CR_API_URL : API_URL + 'https://sdcapi.datadrivendetroit.org';
        ...
        var geoAPI = API_URL + `/1.0/geo/show/tiger${ACS_YEAR_NUMERIC}?geo_ids=` + comparison.geoIDs.join(','),
        ...
        d3.json(geoAPI, function(error, json) {
            ...
            // set a tile layer
            var tiles = L.tileLayer('https://tiles.stadiamaps.com/tiles/stamen_toner_lite/{z}/{x}/{y}@2x.png', { attribution: 'Map tiles by <a href=\"http://stamen.com\">Stamen Design</a>, under <a href=\"https://creativecommons.org/licenses/by/3.0/\" target=\"_blank\">CC BY 3.0</a>. Data by <a href=\"http://www.openstreetmap.org/\" target=\"_blank\">OpenStreetMap</a>, under ODbL.'
            });
    ...
    comparison.mergeMapData = function() {
        ...
        _.each(comparison.geoFeatures, function(e) {
            try {
                ...
                console.log(`Unable to find data for table ${comparison.tableID} for geography ${e.properties.geoid}.`);
                e.properties.data = {
                    error: {},
                    estimate: {},
                    percentage: {},
    ...
    comparison.buildComparisonURL = function(dataFormat, tableID, geoIDs, primaryGeoID, newSumLev) {
        ...
        var dataFormat = dataFormat || comparison.dataFormat,
            ...
            releaseSlug = comparison.releaseSlug || `acs${ACS_YEAR_NUMERIC}_5yr`;
